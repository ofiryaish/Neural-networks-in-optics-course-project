...
m_path = home_dir+'DeepImageDenoising/saved_model_Sony/ES_edsr-lerelu-ps-256-b-32/'
m_name = "best_model.pth"#'edsr_sony_e4000.pth'
result_dir = home_dir+'DeepImageDenoising/Final/early_stopping_edsr_lerelu_ps_256_b_32_edsr_sony_e4000_trained_by_me/'
...
# raw = rawpy.imread(home_dir+'Sony/long/00004_00_10s.ARW')
# input_full = np.expand_dims(pack_raw(raw), axis=0) * 1
